...
class CatListDetailViewController: UIViewController {
    ...
    var detailDelegate: CatListDetailProtocol?
    var safariDelegate: ListSafariServiceDelegateProtocol?
    ...
    private func configureNavigationBar(){
        let addDetailButton = UIBarButtonItem(image: UIImage(systemName: "star.fill"), style: .done, target: self, action: #selector(addDetailButtonTapped))
        title                                                   = "About Cat"
        navigationController?.navigationBar.prefersLargeTitles  = true
        addDetailButton.tintColor                               = .systemYellow
        navigationItem.rightBarButtonItem                       = addDetailButton
    }
...
// Add Detail and Safari Protocol
extension CatListDetailViewController {
    
    @objc func addDetailButtonTapped() {
        detailDelegate?.clickAddCatListDetail(indexPath: indexPath!)
    ...
    @objc func learnMoreButtonTapped() {
        ...
        safariDelegate?.goListLearnAboutCat(for: cat)
    }
}
